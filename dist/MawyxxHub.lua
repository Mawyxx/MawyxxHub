-- MawyxxHub — main framework bundle (299adc2). Auto-generated; do not edit.
local __modules = {}
local __loaded = {}
...
__modules["config/Version"] = function(__require)
...
__modules["hub/MawyxxHub"] = function(__require)
	...
	function MawyxxHub.new(userConfig, deps)
		...
		do
			local Version = __require("config/Version")
...
__modules["init"] = function(__require)
	...
	local Hub = __require("hub/MawyxxHub")
	local Version = __require("config/Version")
